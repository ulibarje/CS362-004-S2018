...
int main2(int argc, char *argv[]) {
	...
	int k[10] = {adventurer, gardens, embargo, village, minion, mine, steward, sea_hag, council_room, smithy};
	struct gameState g;
...
int main(int argc, char* argv[]) {
	...
	//Default cards, as defined in playDom
	int kCards[10] = {adventurer, gardens, embargo, village, minion, mine, steward, sea_hag, council_room, smithy};
