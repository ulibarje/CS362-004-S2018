...
int main() {
	...
	for(test = 0; test < iterations; test++) {
		...
		refGame.hand[randPlayer][0] = gold;
		refGame.hand[randPlayer][1] = gold;

		// printf("player: %d\n", randPlayer);
		// printf("handpos: %d\n", randHandPos);
		// printf("num in hand: %d\n", refGame.handCount[randPlayer]);
		// printf("num in deck: %d\n", refGame.deckCount[randPlayer]);
		// printf("num in discard: %d\n", refGame.discardCount[randPlayer]);
		// printf("treasure 1 to: %d\n", randTreasure1);
		// printf("treasure 2 to: %d\n", randTreasure2);
