...
int main() {
	...
	int i, j, estateFlag, test, randPlayer, randHandPos;
	...
	for(test = 0; test < iterations; test++) {
		...
		refGame.hand[randPlayer][randHandPos] = baron;

		updateCoins(randPlayer, &refGame, 0);
		...
		// Run the test
		choice1 = rand() % 2;
		cardEffect(baron, choice1, choice2, choice3, &testGame, randHandPos, &bonus);

		/****************************************************************************************/
		/****************************************************************************************/

		estateFlag = 0;
		for(j = 0; j < refGame.handCount[randPlayer]; j++) {
			if(refGame.hand[randPlayer][j] == estate)
				estateFlag = 1;
		}

		if(choice1 == 1 && estateFlag) {
			choiceIsOne += 1;
			if(PRINT1)
			...
			if(assertTrue(testGame.handCount[randPlayer], refGame.handCount[randPlayer] - 2)) {
				handCountTC += 1;
			}
			if(PRINT1)
			...
			if(assertTrue(testGame.discardCount[randPlayer], refGame.discardCount[randPlayer] + 1)) {
				discardCountTC += 1;
			}
			/****************************************************************************************/
			if(PRINT1)
		...
		if(choice1 == 0 || estateFlag == 0) {
			...
			if(PRINT1)
				printf("Testing handCount				--->	");
			if(assertTrue(testGame.handCount[randPlayer], refGame.handCount[randPlayer] - 1)) {
				handCountTC += 1;
			}
			if(PRINT1)
				printf("Testing coin count				--->	");
			...
			if(PRINT1)
				printf("Testing number of cards in discard pile		--->	");
			if(assertTrue(testGame.discardCount[randPlayer], refGame.discardCount[randPlayer] + 0)) {
				discardCountTC += 1;
			}
			/****************************************************************************************/
			if(PRINT1)
	...
	printf("choice1 = 0 ran %d times\n", choiceIsZero);
	printf("choice1 = 1 ran %d times\n", choiceIsOne);
	printf("\"estateCount\" variable test 		---> %d/%d tests PASSED\n", (iterations - estateCountTC), iterations);
	printf("\"handCount\" variable test 			---> %d/%d tests PASSED\n", (iterations - handCountTC), iterations);
	printf("\"coinCount\" variable test 			---> %d/%d tests PASSED\n", (iterations - coinCountTC), iterations);
	printf("\"numBuys\" variable test 			---> %d/%d tests PASSED\n", (iterations - numBuysTC), iterations);
	printf("\"discardCount\" variable test 		---> %d/%d tests PASSED\n", (iterations - discardCountTC), iterations);
